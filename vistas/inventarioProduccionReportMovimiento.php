      ...
      <div class="row align-items-center">
        <div class="col-md-12">
          <div class="title mb-30">
            <h2>MOVIMIENTO INVENTARIO MATERIA PRIMA E INSUMOS</h2>
          </div>
        </div>
      </div>
    </div>
...
invProduccionReportMov.classList.add('active')

const tablaTemp = async () => {
  await ajaxListaInformacionGET(
    [
      'modulos/inventarioProduccion/reportInventarioProduccionMovimento.php?d=' + d.value + '&h=' + h
