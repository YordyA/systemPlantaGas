...
<script>
  ...
  venderFacturacionHistorialCxC.classList.add('active')
  ...
  del.addEventListener('change', (e) => {
    e.preventDefault()
    data_table.destroy()
    ListaInformacion(['modulos/reportes/reportHistorialCxC.php?del=' + del.value + '&hasta=' + hasta.value])
  })
