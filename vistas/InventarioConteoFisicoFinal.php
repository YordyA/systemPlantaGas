...
<script>
  ...
  const iniciarConteo = async () => {
    const peticion = await fetch('modulos/conteoFisico/inventarioConteoFisico.php')
  ...
  const listado = async () => {
    const peticion = await fetch('modulos/conteoFisico/inventarioConteoFisicoLista.php')
    const respuesta = await peticion.json()
  ...
  const cambiar_cantidad = async (id, cantidad) => {
    const peticion = await fetch('modulos/conteoFisico/inventarioConteoFisicoDiferencia.php?i=' + id +
      '&cantidad=' + cantidad)
    const respuesta = await peticion.json()
  ...
  const terminarConteoFisico = async () => {
    const peticion = await fetch('modulos/conteoFisico/inventarioConteoFisicoCompletar.php')
    const respuesta = await peticion.json()
    console.log(respuesta)
    if (respuesta[0]) {
      Swal.fire({
  ...
  const cancelar_despacho = async () => {
    const peticion = await fetch('modulos/conteoFisico/inventarioConteoFisicoCancelar.php')
    const respuesta = await peticion.json()
    if (respuesta == true) {
      listado()
      Swal.fire({
